        ...
        <div class="card-boy m-auto">
          <form action="" method="POST">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" id="sex" aria-describedby="nameVal" name="sex" placeholder="<?php echo $fetch_info['sex'] ?>" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="birthday" class="col-sm-3 col-form-label">Ngày sinh</label>
              <div class="col-sm-9">
                <input type="date" class="form-control" id="birthday" placeholder="<?php echo $fetch_info['birthday'] ?>">
              </div>
            </div>
            <div class="mb-3 row">
